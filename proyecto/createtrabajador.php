<?php
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = 'INSERT INTO encargados_areap (ID_personal, Nombre, Apellido_Paterno, Area) values(?,?,?,?)';
			$q = $pdo->prepare($sql);
			$q->execute(array($ID_personal,$Nombre,$Apellido_Paterno,$Area));
			Database::disconnect();
	...
	<body>
	    <div class="container">
	    	<div class="span10 offset1">
				...
				<form class="form-horizontal" action="createtrabajador.php" method="post">

					<div class="control-group <?php echo !empty($ID_personalError)?'error':'';?>">
						<label class="control-label">ID_personal</label>
					    <div class="controls">
					      	<input name="ID_personal" type="text"  placeholder="ID_personal"
									value="<?php echo !empty($ID_personal)?$ID_personal:'';?>">
					...
					<div class="control-group <?php echo !empty($AreaError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="Area" type="text"  placeholder="Area"
									value="<?php echo !empty($Area)?$Area:'';?>">
					...
					<div class="form-actions">
						...
						<a class="btn-secondary" href="trabajadores.php">Regresar</a>
					</div>
